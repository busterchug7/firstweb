      ...
      <div className="max-w-7xl mx-auto">
        ...
        <ScrollReveal className="text-center mb-16">
          ...
          <p className="text-[#9CA3AF] max-w-xl mx-auto text-base leading-relaxed">
            From first impression to final conversion — we handle the full
            picture.
          </p>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {services.map((service, i) => (
            <ScrollReveal key={service.title} delay={i * 0.1}>
              <div className="group bg-[#141414] border border-[#2A2A2A] rounded-lg p-6 h-full hover:border-[#C9A84C]/60 transition-all duration-300 hover:bg-[#141414]/80">
                {/* Icon */}
